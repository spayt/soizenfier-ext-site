      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="space-y-8 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <section className="space-y-4">
            ...
            <p>
              To provide core functionality, we may process the following data:
            </p>
            ...
            <p>
              This data is used strictly to operate and improve the application.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              We use third-party services such as Firebase (Google) to store and
              process data. These services may collect information in accordance
          ...
          <section className="space-y-4">
            ...
            <p>
              {APP_NAME} uses third-party payment providers such as Stripe and
              PayPal to process payments.
            </p>
            <p>
              We do not store any credit card or banking information. All
              payment transactions are handled directly by these providers in
          ...
          <section className="space-y-4">
            ...
            <p>
              In case of an error, technical data may be collected such as IP
              address, device type, operating system version, and usage
              timestamps.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              This application does not explicitly use cookies, but third-party
              services may use them to improve their services.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              any time by contacting us at {COMPANY_EMAIL}.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              The app may contain links to external sites. We are not
          ...
          <section className="space-y-4">
            ...
            <p>
              This application is not intended for children under 13. We do not
